    ...
    Dteb: (e, t, a) => {
      ...
      const ea = function (e) {
        var t,
          ...
          U = Y.data,
          z = Y.fetchMore,
          Y2 = (0, he.JDV)({ variables: Qt(Qt({}, x), {}, { roles: [he.by3.MAIN], types: [he.iqi.ALBUM, he.iqi.EP, he.iqi.SINGLES], mode: he.rb0.NON_OFFICIAL }) }),
          U2 = Y2.data,
          z2 = Y2.fetchMore,
          Z = (0, he.JDV)({ variables: Qt(Qt({}, x), {}, { roles: [he.by3.FEATURED], types: [he.iqi.ALBUM, he.iqi.EP, he.iqi.SINGLES], mode: he.rb0.OFFICIAL }) }),
          K = Z.data,
          q = Z.fetchMore,
          ...
          Q2 = $t(null == U2 || null === (i2 = U2.artist) || void 0 === i2 ? void 0 : i2.albums.edges),
